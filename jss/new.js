...
var resultado = (0.1 + 0.2).toFixed(1);
let object={
    propiedad1:10,
...
function tablademultiplicarfor(tabla,limite){
    for(let indexwhile=0; index<100; index++){
        let number=8*index;
        console.log(number);
    }
}
function tablademultiplicarwhile(tabla,limite){
let indexwhile=0;
...
function tablademultiplicardowhile(tabla,limite){
    let number=0;
    do{
